...
-- Module  Version: 7.1
--C:\lscc\diamond\1.3\ispfpga\bin\nt\scuba.exe -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo2c00 -type bram -wp 11 -rp 1010 -data_width 8 -rdata_width 8 -num_rows 1024 -cascade 11 -mem_init0 -writemodeA NORMAL -writemodeB NORMAL -e 

-- Fri Mar 21 10:22:27 2014
...
architecture Structure of DataBuffer is
    ...
    attribute MEM_LPC_FILE of DataBuffer_0_0_0_0 : label is "DataBuffer.lpc";
    attribute MEM_INIT_FILE of DataBuffer_0_0_0_0 : label is "INIT_ALL_0s";
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of DataBuffer is
    for Structure
